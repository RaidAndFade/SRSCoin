...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // SrsCoin: 0.35 days
static const int64 nTargetSpacing = 15; // SrsCoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal SrsCoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "This block was released on 13-12-2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
